...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'npo_logo.jpg')) {
		$tcpdf_header_logo = 'npo_logo.jpg';
	}
...
// define PDF_PAGE_FORMAT constant as 8x13 inches
if (!defined('PDF_PAGE_FORMAT')) {
	define ('PDF_PAGE_FORMAT', '8x11');
	}
...
if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Work Order Report');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by National Printing Office");
}

// define PDF_UNIT constant as inches
if (!defined('PDF_UNIT')) {
	define ('PDF_UNIT', 'in');
}
